    ...
    <nav class="navbar navbar-inverse">
        ...
        if($result)
        {
            if(mysqli_num_rows($result) > 0)
            {
                ...
                {
                    if ($row['hotels'] == 'The Lofts at Town Centre' )
                      
                    echo "
                        <div>
                               <h2 style='color:white'> Welcome to The Lofts at Town Centre </h2>   
                            </div>
                            <div class='form-group'>
                                <label style= 'font-size:20px; color:yellow' for='room_size'>Pick Your Bed Size:</label>&nbsp;
                             <a href='../hotels/TownCentre.php?room_size=".$row['room1']."'><button>QUEEN SIZE</button> </a>
                             <a href='../hotels/TownCentre.php?room_size=".$row['room2']."'><button>STANDARD SIZE</button> </a>
                             <a href='../hotels/TownCentre.php?room_size=".$row['room3']."'><button>KING SIZE</button> </a>
                            </div>
                        </div>
                         "; //echo end                                         
                }                                      
