<?php
    ...
    { 
        extract($_REQUEST); 
        $result=$user->cancelTownInn($hotel_id, $room_size, $checkin, $checkout, $U_id ,$name, $phone, $price,$book);
        if($result)
        {
    ...
    <div class="container">
        ...
        <form action="" method="post" name="room_category">
            <div class="col-md-12 well" >
              <h4 style="color: #ffbb2b" >Click Confirm if you want to cancel "Town Inn Budget Room"</h4><br>
